...
class RouteTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstruction() {
    	...
    	$this->assertInstanceOf('router\Router\Route', $r);
    }
    ...
    public function testRouteWithoutNames() {
    	$this->assertInstanceOf('router\Router\Route', new Route('/foo/bar'));
    }
    ...
    public function testTrailingSlash() {
        $r = new Route('/foo');
        $this->assertInstanceOf('router\Router\Route', $r->matchUrl('/foo/'));
    }
    
    public function testGroupedExpressionWithWildcards() {
        $r = new Route('/foo/(bar|baz):id/*');
        $m = $r->matchUrl('/foo/bar/42');
        $this->assertInstanceOf('router\Router\Route', $m);
