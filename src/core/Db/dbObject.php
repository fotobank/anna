...
//    -----------------добавил-----------------------
    ...
    {
        if(!empty ($this->timestamps) && in_array('createdAt', $this->timestamps, true))
        {
    ...
    public function update($data = null)
    {
        ...
        if(!empty ($this->timestamps) && in_array('updatedAt', $this->timestamps, true))
        {
    ...
    private function paginate($page, $fields = null)
    {
        ...
        $results          = $this->get([$this->pageLimit, $offset], $fields);
    ...
    private function prepareData()
    {
        ...
        foreach($this->data as $key => &$value)
        {
            ...
            if(!in_array($key, array_keys($this->dbFields), true))
            {
                continue;
            }
            ...
            if(isset($this->jsonFields) && in_array($key, $this->jsonFields, true))
            {
                $sqlData[$key] = json_encode($value);
            }
            else if(isset($this->arrayFields) && in_array($key, $this->arrayFields, true))
            {
    ...
    public static function autoload($path = null)
    {
        ...
        spl_autoload_register('core\Db\dbObject::dbObjectAutoload');
    }
}