...
class MysqliDb
{
     ...
     *
     * @return string
     * @internal param $Array - Variable with values
     *
     */
     ...
     * Abstraction method that will build the LIMIT part of the WHERE statement
     *
     * @param integer|array $numRows Array to define SQL limit in
     * format Array ($count, $offset) or only $count
     */
