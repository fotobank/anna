...
class CacheControl
{
    ...
    {
        $this->deleteContainer('public');
        $this->setContainer('private', true);
    ...
    {
        $this->deleteContainer('private');
        $this->setContainer('public', true);
        $this->updateCacheControlHeader();
    }
    ...
    {
        if ($this->containsContainer('s-maxage')) {
            return (int) $this->getContainer('s-maxage');
        }

        if ($this->containsContainer('max-age')) {
            return (int) $this->getContainer('max-age');
        }
    ...
    {
        $this->setContainer('max-age', $value);
        $this->updateCacheControlHeader();
    }
    ...
    {
        $this->setPublic();
        $this->setContainer('s-maxage', $value);
        $this->updateCacheControlHeader();
    }
    ...
    {
        $age = $this->response->getHeader('Age');
        if ($age) {
            return (int) $age;
        }
