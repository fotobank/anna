...
$mustache = new Mustache_Engine( [
	...
	'loader' => new Mustache_Loader_FilesystemLoader( SITE_PATH .'system/views/Mustache/templates'),
	'partials_loader' => new Mustache_Loader_FilesystemLoader(SITE_PATH .'system/views/Mustache/templates/partials'),
