...
$db     = new core\Db\Mysqlidb('localhost', 'root', '', 'testdb');
$prefix = 't_';
$db->setPrefix($prefix);

core\Db\dbObject::autoload('models');
...
$expected =
    '{"customerId":2,"userId":{"id":4,"login":"testuser","active":0,"customerId":0,"firstName":"john","lastName":"Doe Jr","password":"","createdAt":"'
    . $client->createdAt . '","updatedAt":null,"expires":null,"loginCount":0},"productName":"product6","id":6}';
