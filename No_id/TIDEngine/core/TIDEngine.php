...
class TIDEngine{
	 ...
	 * @param string $domain
	 */
	public  $domain  			= 'http://localhost/anna.od.ua/';
	 ...
	 */
	public  $javascript_source		= 'js/native/source/';
	 ...
	 */
	public  $javascript_minified		= 'js/native/minified/';
	 ...
	 */
	public  $frameworks_source		= 'js/frameworks/';
	 ...
	 */
	private $configuration_file 		= 'TIDEngine/configuration/config.php';
	 ...
	 * @param $files
	 *
	 * @return string //$files - CSS file content
	 */
...
//			break;
	...
	//		require (__DIR__.'/../../TIDEngine/core/TIDEbugger.php');
	...
	public function include_packer(){
		switch($this->packer){
			case 'packer':
				...
				require (__DIR__ . '/../../TIDEngine/vendor/JavaScriptPacker/JavaScriptPacker.php');

				break;
			case 'jsmin':

				require (__DIR__.'/../../TIDEngine/vendor/JSMin/JSMin.php');
					
				break;
			case 'jshrink':

				require (__DIR__.'/../../TIDEngine/vendor/JShrink/JShrink.php');

				break;

			case 'jsminplus':
					
				require (__DIR__.'/../../TIDEngine/vendor/JSMinPlus/JSMinPlus.php');
