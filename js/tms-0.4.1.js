							...
							zoomer        : function (el, last) {
								...
								el.each(function () {
									var src = _.next
											...
											, wrap = $('<div></div>')
													.css({
														position: 'absolute', left: 0, top: 0, zIndex: 10, width: holder.width(), height: holder.height(), overflow: 'hidden', opacity: 0
													})
											, css
											, animate = function (canvas, o) {
												var state
														...
														, refresh = function (state) {
															ie
																	? canvas.css({
																left: o.start.left + (o.finish.left - o.start.left) * state, top: o.start.top + (o.finish.top - o.start.top) * state, width: o.start.width + (o.finish.width - o.start.width) * state, height: o.start.height + (o.finish.height - o.start.height) * state
															})
												...
												swtch(motion, {
													zoom   : function () {
														css.finish = swtch(side, {
															left          : {
																left: 0, top: -(height * k - height) / 2
															}, right      : {
																left: -(width * k - width), top: -(height * k - height) / 2
															}, top        : {
																left: -(width * k - width) / 2, top: 0
															}, bottom     : {
																left: -(width * k - width) / 2, top: -(height * k - height)
															}, leftTop    : {
																left: 0, top: 0
															}, rightTop   : {
																left: -(width * k - width), top: 0
															}, leftBottom : {
																left: 0, top: -(height * k - height)
															}, rightBottom: {
																left: -(width * k - width), top: -(height * k - height)
															}, center     : {
																left: -(width * k - width) / 2, top: -(height * k - height) / 2
															}
														})
									...
									buff
											.css({
												left: '-999%', top: '-999%', position: 'absolute'
											})
											.appendTo('body')
											.load(function () {
												width = buff.width()
												...
												wrap
														...
														.animate({
															...
															duration: _.presetParam.crossFadeDur || 2000, complete: function () {
															}
														})
												$.when(wrap)
														.then(function () {
